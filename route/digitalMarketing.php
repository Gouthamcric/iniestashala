		...
		<div class="specific">
			<div class="row">
				<div class="col-md-7 mt-5 text-center">
						<h2 class="p1 mb-3">Learn Skills require in Digital Marketing</h2>
						<p class="lead p1 mb-3">Learn how to increase your business.</p>
				...
				<div class="col-md-5 col-12 part2">
					<img src="../train/digital1.jpg">
			    </div>
			</div>	
		</div>		
	</div>
	<div class="jumbotron mb-5">
		<h3 class="text-center text-black">About Digital Marketing.</h3>
		<p class="text-center">
			With over 20 hours of training, quizzes and practical steps you can follow - this is one of the most comprehensive digital marketing courses available. We'll cover SEO, YouTube Marketing, Facebook Marketing, Google Adwords, Google Analytics and more!.The course is hugely interactive with projects, checklists & actionable lectures built into every section.Learn step by step how to market a business online from scratch across all the major marketing channels.Follow the steps on screen to get results at work, for own business or for your digital marketing clients.Covering 12 major online marketing topics and comprising of 20+ hours of clear cut lectures & practice activities
		</p>
	</div>
			...
			<div class="row  justify-content-between">
				<div class="col-md-3 col-6">
					<div class="card c1 grey-card mb-4">
		 					<div class="card-body ">
		    					<h5 class="card-title lead">Learn SEO</h5>
		    					<p class="card-text">Search Engine Optimisation:Get free traffic to your website with SEO</p>
		  					</div>
					</div>
				</div>
				<div class="col-md-3 col-6 ">
					<div class="card c1 grey-card mb-4">
		 					<div class="card-body">
		    					<h5 class="card-title lead">Learn Marketing</h5>
		    					<p class="card-text">Learn Youtube,Instagram,Facebook i.e Social Media Marketing and many more.</p>
		  					</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					<div class="card c1 grey-card mb-4">
		 					<div class="card-body">
		    					<h5 class="card-title lead">Google Analytics</h5>
		    					<p class="card-text">Improve your Data by using Google Analytics certificate.</p>
		  					</div>
					</div>
				</div>
				<div class="col-md-3 col-6 ">
					<div class="card c1 grey-card mb-4">
		 					<div class="card-body">
		    					...
		    					<p class="card-text">Make money as a Freelance marketer or using Google Adwords</p>
		  					</div>
					</div>
				</div>
					...
					<div class="card">
						<div class="row">
							...
							<div class="card_details col-md-9">
								...
								<div class="card_description"><p>
	                                Get Hands on excercise with professional mentor as your tutor. 
	                            </p></div>
							</div>
						</div>
					</div>
