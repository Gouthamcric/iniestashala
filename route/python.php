...
<body>
		...
		<div class="specific">
			<div class="row">
				<div class="col-md-7 mt-5 text-center">
						<h2 class="p1 mb-3">Programming with Python</h2>
						<p class="lead p1 mb-3">Build A Cricket Fantasy Game Using Python..</p>
	...
	<div class="jumbotron mb-5">
		<h3 class="text-center text-black">About Programming with Python</h3>
		<p class="text-center">
			The online training, Programming with Python, is a 6-week training program covering essential concepts on the building blocks of Python, object-oriented programming, the use of SQLite database and development of GUIs for Python applications. This training program has been created by Internshala to make the process of learning enjoyable yet effective. You will learn through videos, visual organizers and practice exercises. For a great hands-on learning experience, this training program is packed with assignments, assessment tests, code challenges, quizzes, and exercises.
		</p>
	</div>
			...
			<div class="row  justify-content-between">
				<div class="col-md-3 col-6">
					<div class="card c1 grey-card mb-4">
		 					<div class="card-body ">
		    					<h5 class="card-title lead">Introduction to Python</h5>
		    					<p class="card-text">Learn how to install Python, distinguish between important data types and use basic features of the Python interpreter, IDLE.You will learn all the basics.</p>
		  					</div>
					</div>
				</div>
				<div class="col-md-3 col-6 ">
					...
					<div class="card">
						<div class="row">
							...
							<div class="card_details col-md-9">
								...
								<div class="card_description"><p>
	                                Create a smart Calculator using Python.
	                            </p></div>
							</div>
						</div>
					</div>
