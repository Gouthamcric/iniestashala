...
CREATE TABLE IF NOT EXISTS `application` (
  ...
  `app_status` varchar(50) NOT NULL DEFAULT 'applied',
  PRIMARY KEY (`id`)
...
INSERT INTO `application` (`id`, `company_id`, `applicant_id`, `answers`, `date`, `app_status`) VALUES
(32, '1', 'goutham@gmail.com', 'yes,no,prefer not to answer', '2002-04-19', 'rejected'),
(33, '2', 'goutham2@gmail.com', 'yes,no,none', '2003-05-20', 'under review'),
(34, '3', 'goutham@gmail.com', '', '2020-05-09', 'applied'),
(35, '5', 'goutham2@gmail.com', 'sd,', '2020-05-09', 'applied'),
(36, '1', 'goutham2@gmail.com', 'SDA,ASD,DSA,DSA', '2020-05-09', 'applied'),
(38, '1', 'goutham_temp@gmail.com', 'fsd,dsf,dfs,fds', '2020-05-13', 'applied');
...
(3, 'Accounts'),
(4, 'Acting'),
(5, 'Agriculture & Food Engineering'),
(6, 'Analytics'),
(7, 'Android App Development'),
(8, 'Angular .js Development'),
(9, 'Animation'),
(10, 'Architecture'),
(11, 'Artificial Intelligence'),
(12, 'ASP.NET Development'),
...
(20, 'Brand Management'),
(21, 'CAD Design'),
(22, 'Campus Ambassador'),
(23, 'Chartered Accountancy(CA)'),
...
(52, 'Event Management'),
(53, 'Facebook Marketing'),
(54, 'Fashion Design'),
(55, 'Film Making'),
(56, 'Finance'),
(57, 'Front End Development'),
...
(66, 'Human Resources'),
(67, 'Image Processing'),
(68, 'Industrial Design'),
(69, 'Information Technology'),
(70, 'Instrumentation & Control Engineering'),
(71, 'Interior Design'),
(72, 'Internet Of Things'),
(73, 'iOS App Development'),
(74, 'Java Development'),
(75, 'Jvascript Development'),
(76, 'Journalism'),
(77, 'Law'),
(78, 'Legal Research'),
(79, 'Machine Learning'),
(80, 'Manento Development'),
(81, 'Manufacturing Engineering'),
(82, 'Market/Business Research'),
(83, 'Marketing'),
(84, 'Mathematics '),
(85, 'Mathematics & Computing'),
(86, 'MBA'),
(87, 'Mechanical Engineering'),
(88, 'Mechatronics'),
(89, 'Media '),
(90, 'Medicine'),
(91, 'Merchandise Design'),
(92, 'Metallurgical Engineering'),
(93, 'Mobile App Development'),
(94, 'Motion Graphics'),
(95, 'Network Engineering'),
(96, 'NGO'),
(97, 'Node .js Development'),
(98, 'Operations'),
(99, 'Pharamaceutical'),
(100, 'Photography'),
(101, 'PHP Development'),
(102, 'Physics'),
(103, 'Political/Economics/Policy Research'),
(104, 'Public Relations (PR)'),
(105, 'Product Management'),
(106, 'Programming'),
(107, 'Psychology'),
(108, 'Phython/Django Development'),
(109, 'Recruitment'),
(110, 'Ruby on Rails'),
(111, 'Sales'),
(112, 'Science'),
(113, 'Search Engine Optimization(SEO)'),
(114, 'Social Media Marketing'),
(115, 'Social Work'),
(116, 'Software Development'),
(117, 'Software Testing'),
(118, 'Statistica'),
(119, 'Stayergy'),
(120, 'Supply Chain Management (SCM)'),
(121, 'Talent Acquisition'),
(122, 'Teaching'),
(123, 'Telecalling'),
(124, 'Travel & Tourism'),
(125, 'UI/UX Design'),
(126, 'Video Making/Editing'),
(127, 'Videography'),
(128, 'Volunteering'),
(129, 'Web Development'),
(130, 'Wordpress Development'),
(131, 'dsa'),
(132, 'dsa'),
(133, 'sda');
...
CREATE TABLE IF NOT EXISTS `data` (
  ...
  `work_home` varchar(11) DEFAULT NULL,
  `partime` varchar(11) DEFAULT NULL,
  `start_date` varchar(30) DEFAULT NULL,
  `duration` varchar(11) DEFAULT NULL,
  `internship_women` varchar(11) DEFAULT NULL,
  `job_offer` varchar(11) DEFAULT NULL,
  `company_name` varchar(50) DEFAULT NULL,
  `location` varchar(50) DEFAULT NULL,
  `stipend` varchar(11) DEFAULT NULL,
  `posted_on` varchar(40) DEFAULT NULL,
  `apply_by` varchar(30) DEFAULT NULL,
  `category` varchar(150) DEFAULT NULL,
  `openings` varchar(11) DEFAULT NULL,
  ...
  `approval_status` varchar(50) NOT NULL DEFAULT 'Not Approved',
  PRIMARY KEY (`id`)
...
INSERT INTO `data` (`id`, `job`, `work_home`, `partime`, `start_date`, `duration`, `internship_women`, `job_offer`, `company_name`, `location`, `stipend`, `posted_on`, `apply_by`, `category`, `openings`, `responsibility`, `perks`, `skills`, `questions`, `description`, `owner`, `approval_status`) VALUES
(1, 'Interior Design(3D)', '0', '1', '2020-04-30', '2', '1', '1', 'Acel Rivers Design Studio', 'Zirakpur', '3000', '2020-04-15', '2020-04-23', '3D printing,Animation', '4', 'write code in php,write code in javascript', 'certificate', 'javascript,php', 'paste link of your previous work-,have you completed your graduation?', 'its a good company', 'goutham_as_employer@gmail.com', 'Approved'),
(2, 'Food Technology', '1', '0', '2020-05-30', '2', '0', '0', 'Cosmo Ecosystem Care LLP', 'work from home', '1000', '2020-04-30', '2020-05-02', 'Agriculture & Food Engineering', NULL, NULL, NULL, '', NULL, NULL, 'goutham_as_employer@gmail.com', 'Approved'),
(3, 'Chartered Accountancy', '0', '1', '2020-04-30', '12', '1', '0', 'HP Incorporation', 'Bangalore', '10000', '2020-04-01', '2020-04-15', 'Accounts,Chartered Accountancy(CA)', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(4, 'Cartooning', '1', '0', '2020-04-23', '3', '1', '0', 'Commondove', 'work from home', 'Unpaid', '2020-04-01', '2020-04-15', 'Animation', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(5, 'Anchoring', '0', '1', '2020-04-30', '2', '1', '0', 'HR Executive Consultants', 'Delhi', '3000', '2020-04-01', '2020-04-15', 'Acting', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(6, 'Voice Over Artist', '0', '1', '2020-04-22', '3', '0', '0', 'Voice Monk Studio', 'Noida', '6000', '2020-04-01', '2020-04-10', 'Acting', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(7, 'Graphic Design', '1', '0', '2020-04-30', '3', '0', '1', 'Data Folkz', 'work from home', '7000', '2020-04-01', '2020-04-15', 'Acting,Video Making/Editing,Videography,Graphic Development', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(8, 'Health Advisor(Diet/Nutrition)', '0', '1', '2020-05-20', '3', '1', '1', 'Isurgics Health Solution', 'Delhi,Ghaziabad,Noida,Gurgaon', '5000', '2020-04-23', '2020-04-30', 'Biology', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(9, 'Content Writing', '1', '0', '2020-05-01', '6', '0', '1', 'Study Heights', 'Work_ Home', '5000', '2020-04-01', '2020-04-22', 'Acting,Blogging,Cinematography', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(10, 'Web Development', '1', '0', '2020-04-30', '1', '1', '0', 'Snapcut', 'work from home', '6000', '2020-04-01', '2020-04-15', 'Backend Development, Computer Science, Data Science', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(11, 'Machine Learning', '0', '0', '2020-05-30', '1', '1', '1', 'Center for Modern Skills Development India', 'Chennai,Coimbatore,Nagercoil,Vijayawada', '2000', '2020-04-01', '2020-04-25', 'Backend Development, Cmputer Science,Data Science', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(12, 'Campus Ambassador', '1', '0', '2020-04-30', '1', '0', '0', 'Aeva Fashions', 'work from home', 'Performnanc', '2020-04-15', '2020-04-29', 'Campus Ambassador', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(13, 'Hadoop', '0', '0', '2020-04-30', '1', '1', '1', 'Center For Modern Skills Development India', 'Chennai, Coimbatore,Nagercoil,Vijayawada', '2000', '2020-04-01', '2020-04-23', 'Artificial Intelligence(AI),Cloud Computing,Computer Science', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(14, 'Full Stack Development', '1', '0', '2020-05-30', '2', '1', '0', 'Create Your Development', 'work from home', '2000', '2020-04-30', '2020-05-20', 'Artificial Intelligence(AI),Cloud Computing,Computer Science,Full Stack Developmnet', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(15, 'Angular .js Development', '1', '0', '2020-04-30', '4', '1', '0', 'Tradexa Technologies Private Limited', 'Work_ Home', '10000', '2020-04-01', '2020-04-24', 'Artificial Intelligence(AI),Cloud Computing,Computer Science, Angular.js Development', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(16, 'Web Development', '1', '0', '2020-04-30', '1', '0', '1', 'Reach Technologies', 'work from home', '5000', '2020-04-01', '2020-04-15', 'Artificial Intelligence(AI),Cloud Computing,Computer Science,Web Development', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(17, 'Accounts Receivable', '0', '1', '2020-04-30', '6', '1', '0', 'IKS Health', 'Pune,Hyderabad,Thane,Navi Mumbai', '8000', '2020-04-01', '2020-04-23', 'Accounts,Commerce', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(18, 'Subject Matter Expert(Business Management)', '0', '1', '2020-05-26', '3', '0', '0', 'RM Learning', 'Delhi', '10000', '2020-04-16', '2020-04-30', 'Accounts,Commerce', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(19, 'Telecalling & Data Entry', '0', '1', '2020-06-01', '1', '0', '0', 'FISME', 'Delhi', '6000', '2020-05-01', '2020-05-20', 'Data Entry', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(20, 'PCB Design', '0', '1', '2020-04-30', '6', '0', '0', 'JUNO TERRA', 'Delhi', '6000', '2020-04-01', '2020-04-16', 'Electrical Engineering, Engineering', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(21, 'Digital Marketing', '0', '0', '2020-04-22', '3', '1', '0', 'Nueva Technologies LLP', 'Noida, Ghaziabad, Gurgaon', '7000', '2020-04-01', '2020-04-21', 'Digital Marketing', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(22, 'Content Writing', '0', '0', '2020-04-24', '6', '1', '1', 'Edusaksham', 'Noida', '10000', '2020-04-08', '2020-04-11', 'Content Writing, Creative Writing', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(23, 'Video Analytics Using Phython', '0', '1', '2020-05-20', '6', '1', '1', 'Ebisu Technologies Private Limited', 'Bangalore', '20000', '2020-04-16', '2020-04-30', 'Computer Science,Engineering,Video Making/Editing,Analytics', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(24, 'NGO Management Program', '0', '1', '2020-05-28', '6', '1', '1', 'Shasikant Rural Development India', 'Chennai, Bangalore', '5000', '2020-04-15', '2020-04-30', 'Social Work, Volunteering, Hospitality', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(25, 'Human Resources(HR)', '0', '1', '2020-04-30', '3', '1', '0', 'Creatorshala', 'Delhi, Gurgaon, Mumbai', '6000', '2020-04-22', '2020-04-29', 'Human Resources(HR), Humanities,hospitality', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(26, 'Customer Service', '0', '1', '2020-04-22', '3', '1', '1', 'Kaafi Enterprises Private Limited', 'Mumbai', '7000', '2020-04-15', '2020-04-21', 'Customer Service, Hospitality', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(27, 'Kitchen Management And Cooking', '0', '1', '2020-04-30', '2', '1', '0', 'Make Me Builder', 'Gurgaon,Delhi, Faridabad', '4000', '2020-04-29', '2020-04-29', 'Hotel Management, Hospitality', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(28, 'Mobile App Development', '0', '1', '2020-04-22', '6', '1', '1', 'ThirdLeap', 'Hyderabad', '10000', '2020-04-14', '2020-04-20', 'Computer Science,Engineering,Android App Development,Mobile App Development', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(29, 'Journalism', '0', '1', '2020-04-18', '3', '1', '0', 'SSBCrackExams', 'Hyderabad', '13000', '2020-04-12', '2020-04-16', 'Journalism', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(30, 'Cyber Security', '0', '1', '2020-04-28', '3', '1', '0', 'Paralok Information Security Limited', 'Hyderabad,Mumbai,Chennai', '6000', '2020-04-12', '2020-04-20', 'Computer Science, Cyber Security, Engineering', NULL, NULL, NULL, '', NULL, NULL, '', 'Approved'),
(46, 'Web Development', '0', '0', '2020-04-09', '5', '0', '0', 'Insinew Ventures Private Limited', '', 'unpaid', '2020-4-25', '2020-5-25', 'Backend Development, Computer Science, Data Science \r\n', '3', '1. Working on web development using software technologies such as PHP, Laravel, ReactJS, etc.\n2.can start the work from home job/internship between 11th Apr\'20 and 16th May\'20\n3.are available for duration of 3 months\n4.have relevant skills and interests\n', 'certificate,letter of recommendation,5 days a weeks', 'PHP (Learn PHP), LARAVEL, React Native and ReactJS', '', ' We focus on delivering technology solutions to our customers. Our key strengths are technology consulting, software development, and digital marketing for improved digital outreach. If you are looking for an opportunity to work with an active team of passionate workaholics, join us, we will get started right away.', '', 'Approved'),
(47, 'Business Development (Sales)', '0', '1', 'immediately', '2', '0', '1', 'fdsfds', '', 'negotiable', '2020-5-1', '2020-6-1', '', '4', 'dsaadsdas', 'certificate,flexible work hours', 'dsaADSdsa', '', 'fsdsdf', '', 'Approved'),
(49, 'Business Development (Sales)', '0', '1', 'immediately', '2', '0', '1', 'fdsfds', '', 'negotiable', '2020-5-1', '2020-6-1', ' \r\n', '4', 'dsaadsdas', 'certificate,flexible work hours', 'dsaADSdsa', 'DSADSADAS', 'fsdsdf', '', 'Approved'),
(51, 'Business Development (Sales)', '0', '0', 'immediately', '3', '0', '0', 'sdagoutham', '', 'negotiable', '2020-5-8', '2020-6-8', ' \r\n', '3', 'sdasadsda\ndassaddsa\nsadsdadsa', 'certificate', 'java', 'r u really gonna join?', 'sda', '', 'Approved'),
(60, 'Business Development (Sales)', '0', '0', 'immediately', '2', '0', '0', 'fdg', '', 'negotiable', '2020-5-12', '2020-6-12', ' \r\n', '', 'saddsa', 'certificate', 'java', '', 'fgd', 'goutham_as_employer@gmail.com', 'Not Approved');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `job_pre_1` varchar(30) DEFAULT NULL,
  `job_pre_2` varchar(30) DEFAULT NULL,
  `job_pre_3` varchar(30) DEFAULT NULL,
  `city_pre_1` varchar(30) DEFAULT NULL,
  `city_pre_2` varchar(30) DEFAULT NULL,
  `city_pre_3` varchar(30) DEFAULT NULL,
  `education` varchar(1000) NOT NULL DEFAULT '',
  `internships` varchar(1000) NOT NULL DEFAULT '',
  `trainings` varchar(1000) NOT NULL DEFAULT '',
  `projects` varchar(1000) NOT NULL DEFAULT '',
  `work_samples` varchar(1000) NOT NULL DEFAULT '',
  `skills` varchar(1000) NOT NULL DEFAULT '',
  `additional_details` varchar(1000) NOT NULL DEFAULT '',
  `approval_status` varchar(100) NOT NULL DEFAULT 'Not Approved',
  PRIMARY KEY (`id`)
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `phone`, `email`, `password`, `is_employer`, `city1`, `city2`, `type`, `job_pre_1`, `job_pre_2`, `job_pre_3`, `city_pre_1`, `city_pre_2`, `city_pre_3`, `education`, `internships`, `trainings`, `projects`, `work_samples`, `skills`, `additional_details`, `approval_status`) VALUES
(1, 'goutham', 'goutham', '9340554408', 'goutham_temp@gmail.com', 'gnq316', 0, 'sdg', 'gds', 'full time,work from home,partime', 'Accounts', 'Accounts', '3D printing', 'Adilabad', 'Kolhapur', 'Chirala', '12th,2017,89@11th,2017,89@', 'inieasta web tech sol.,backend developer,3@', 'web development,3@', 'nutrition analysis using CNN#nothing much to tell.@', 'github.com/gouthamcric,goutham.com/gou2am^', 'java,beginner@python,beginner@', 'saddsaasd@', 'Approved'),
(3, 'Goutham', 'natarajan', '9340554408', 'goutham2@gmail.com', 'gnq316', 0, 'Hyderabad', 'Chennai', 'full time,work from home,partime', 'Android App Development', 'Android App Development', 'Big Data ', 'Chennai', 'Coimbatore', 'Hyderabad', '12th,2017,89@11th,2017,78@', 'iieasta,web developer,2@', 'IOT,2iot,3@', 'sf#fsa@2nd#dsasdsadasdadsa\nsaddasdasd\ndsaasdasda@zcx#cz@sdfa#dsa@', 'dfs,af^google.com,facebook.com^cxz,af^sda,sad^sad,asd^', 'c++,beginner^java,beginner^dfs,beginner@dfs,beginner@', '@@@dsfsd@', 'Approved'),
(9, 'gpu', '', '93832989023', 'goutham_as_employer@gmail.com', 'gnq316', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', '', '', 'Approved');
COMMIT;
